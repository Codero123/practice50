class Security {
    ...
    constructor(){
        ...
        this.access4.position(windowWidth-400,windowHeight-455);
        this.access4.style('background', 'white');  

        this.button4 = createButton('Check');
        this.button4.position(windowWidth-400,windowHeight-425);
        this.button4.style('background', 'lightgrey');    

        this.access5 = createInput("Code1")
        this.access5.position(windowWidth-400,windowHeight-255);
        this.access5.style('background', 'white');  

        this.button5 = createButton('Check');
        this.button5.position(windowWidth-400,windowHeight-225);
        this.button5.style('background', 'lightgrey');

        this.access6 = createInput("Code1")
        this.access6.position(windowWidth-1100,windowHeight-455);
        this.access6.style('background', 'white');  

         this.button6 = createButton('Check');
         this.button6.position(windowWidth-1100,windowHeight-425);
        ...
        this.access9.position(windowWidth-1100,windowHeight-255);
        this.access9.style('background', 'white');  

        this.button9 = createButton('Check');
        this.button9.position(windowWidth-1100,windowHeight-225);
        this.button9.style('background', 'lightgrey');
  

        this.access10 = createInput("Code1")
        this.access10.position(windowWidth-1100,windowHeight-655);
        this.access10.style('background', 'white');  

        this.button10 = createButton('Check');
        this.button10.position(windowWidth-1100,windowHeight-625);
